...
<head>
    ...
    <link rel="stylesheet" href="./styles/customize_aman.css">
...
<body>
    ...
    <nav class="nav">
        <div class="nav-menu flex-row">
            <div class="nav-brand">
                <a href="index.php" class="text-gray">Blog Page</a>
            </div>
    ...
    <main>
        ...
        <section class="site-title">
            <div class="site-background" data-aos="fade-up" data-aos-delay="100">
                <h2>Buy & Gift</h2>
                <h1>You can always find something you want</h1>
            ...
            <div class="blog">
                <div class="container">
                    <div class="owl-carousel owl-theme blog-post">
                        <div class="blog-content a_img" data-aos="fade-right" data-aos-delay="200">
                        ...
                        <div class="blog-content a_img" data-aos="fade-in" data-aos-delay="200">
                        ...
                        <div class="blog-content a_img" data-aos="fade-left" data-aos-delay="200">
    ...
    <footer class="footer">
        ...
        <div class="rights flex-row">
            <h4 class="text-gray">
                ...
                <a href="#" target="_black">RAF Production</a>
            </h4>
        </div>
        <div class="move-up">
